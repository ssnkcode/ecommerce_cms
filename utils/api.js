...
// En desarrollo se deduce del host desde el que se abrió la página, para que
// funcione tanto en localhost como desde el celular vía IP de red local.
const envApiUrl =
...
export const API_BASE_URL = envApiUrl ? envApiUrl.replace(/\/+$/, '') : defaultApiUrl()
